...
{
    fetch('http://localhost:8080/EntregaFinalCacBackend/peliculas/', 
        {
        method: 'POST',
        headers: {
...
function loadItems() {
  ...
  {
    fetch(`http://localhost:8080/EntregaFinalCacBackend/peliculas/${id}`, 
        {
        method: 'DELETE',
        headers: {
            'Content-Type': 'application/json'
...
{
      fetch(`http://localhost:8080/EntregaFinalCacBackend/peliculas/${data.id}`, 
        {
        method: 'PUT',
        headers: {
            'Content-Type': 'application/json',
